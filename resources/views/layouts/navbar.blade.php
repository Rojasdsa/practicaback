...
<nav class="navbar navbar-expand-lg custom-nav py-0">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="https://pbs.twimg.com/profile_images/947504948765450240/nZtFY4Lb_400x400.jpg" class="rounded-circle custom-nav-logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('/') ? 'custom-active-link' : '' }}" href="{{ url('/') }}">Inicio</a>
                </li>
                <li class="nav-item">
